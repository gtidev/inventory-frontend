<div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
          <form name="doCreate" action="<?php echo base_url('/Satuan/doCreate')?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              <hr><h5 class="text-center">Input Ruang</h5><hr>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        <label for="nama">Hitungan</label>
                        <input type="text" class="form-control" name="hitungan_turunan">
                        <div class="valid-feedback">
                            ✓
                        </div>
                        <div class="invalid-feedback">
