<div class="container">
    ...
    <div class="row">
      <div class="col-sm-12">
          <form name="doCreate" action="<?php echo base_url('/Keuangan/doCreate')?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
              <hr><h5 class="text-center">Input Referensi</h5><hr>
                    ...
                    <div class="form-row">
                      ...
                      <div class="col-md-4 mb-3">
                        <label for="propinsi">Status Aliran</label>
                        <select class="custom-select" name="status_aliran">
                            <option selected disabled value="">Pilih</option>
                            <?php 
                                foreach($status_aliran as $value) {
                            ?>
                      ...
                      <div class="col-md-4 mb-3">
                        ...
                        <input type="text" class="form-control" name="sumber_aliran">
                        <div class="valid-feedback">
                            ✓
                        </div>
                        <div class="invalid-feedback">
                      ...
                      <div class="col-md-4 mb-3">
                        <label for="nama">Status Pajak</label>
